    ...
    <>
      ...
      <section>
        ...
        <p className="text-foreground">
          ...
          , currently building a drag and drop form builder and layout designer.
          passionate about gym and programming languages;
        </p>
        <p className="text-foreground">
          and improving the React&apos;s ecosystem by scratching a new drag and
          drop open-source library called{" "}
          <Link
            href="https://github.com/joaodematte/grippy"
            target="_blank"
            external
          >
            grippy
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <Link
              href="https://linkedin.com/in/dematte"
              target="_blank"
              external
            >
              linkedin
